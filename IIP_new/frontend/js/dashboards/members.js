      ...
      <div class="tile">
        <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:12px;flex-wrap:wrap;gap:8px">
          ...
          <div style="display:flex;gap:8px;align-items:center">
            <input id="members-search" type="text" class="search-input" placeholder="Search member..."
              style="width:200px"/>
    ...
    container.innerHTML = `
      ...
      <div class="grid-2 mt-5">
        <div class="tile">
          ...
          <div class="chart-canvas-wrap" style="height:200px"><canvas id="chart-member-trend"></canvas></div>
        </div>
        <div class="tile">
